...
# 병합 결과에서 oo.ai 크롤링으로 정성적인 필드 정보 수집
ooai_data_result = enrich_company_data(integration_result.get('name'), integration_result)
...
# 정제 로직 실행
filtered_data = filtering_company_info(ooai_data_result)
print("\n=== 정제된 회사 정보 ===\n")
